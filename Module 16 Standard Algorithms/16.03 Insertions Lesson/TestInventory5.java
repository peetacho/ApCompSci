...
public class TestInventory5
{
    public static void main(String[] args)
    {
        ...
        System.out.println();
        System.out.println();
        insertItem(inventory, 2, "Relaxation Kit", 1000);
        ...
        System.out.println();
        System.out.println();
        insertItem(inventory, "Towel", "Hair Dryer", 500);
    ...
    public static void insertItem(InventoryItem[] itemList, int location, String addN, int addS)
    {
    ...
    public static void insertItem(InventoryItem[] itemList, String find, String addN, int addS)
    {
        int location = 0;
