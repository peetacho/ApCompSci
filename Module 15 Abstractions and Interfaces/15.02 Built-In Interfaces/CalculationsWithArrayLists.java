...
public class CalculationsWithArrayLists
{
    ...
    {
        // Previous ArrayList declarations
        ...
        // New ArrayList declarations using the List interface
        ...
        {
            answers.add(numList1.get(i) + numList2.get(i));         //gets a random number from index position i in the first and second array,
